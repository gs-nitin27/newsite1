...
{
   $.ajax({
    url:"http://localhost/testingapp/getSportyLite/litecontroller.php?act=blog_api&token_id=dhs2016&token=0,1,3",crossDomain: true ,success: function(result)
    {
        $( "#img1" ).hide();
        ...
        resources_temp +='<div class="item"> <div class="img-box"> <img src="https://getsporty.in/portal/uploads/resources/'+data.image+'"> </div> <div class="white-b"> <h4>Aanchal Thakur wins India first skiing medal</h4> <p>Aanchal Thakur entered into the history books after she clinched a Bronze medal in the coveted Alpine Ejder 3200 Cup organized by the Federation Internationale de Ski. Aanchal, who hails from a small...</p> <p class="read-c"> Read More </p> </div> </div>';
        });
        $("#customers-testimonials").html(resources_temp);
        // for (var i = 0; i < 11; i++)
        // {  
       ...
       // resources_temp = ""; 
       // resources_temp += '<div style="margin-top:25%"><a href="http://localhost/getsportySite/resources.html"><h3>View More-</h3></a></div>';
...
function getJob()
{
   $.ajax({
    url:"https://getsporty.in/liveapp/getSportyLite/litecontroller.php?act=job_api",crossDomain: true ,success: function(result)
    {
       ...
       job_temp += '<div style="margin-top:25%"><a href="http://localhost/getsportySite/job_list.html"><h3>View More-</h3></a></div>';
